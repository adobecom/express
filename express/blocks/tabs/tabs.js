...
const init = (block) => {
  ...
  const paddleLeft = createTag('button', {
    class: 'paddle paddle-left', disabled: '', 'aria-hidden': true, 'aria-label': 'Scroll tabs to left',
  }, PADDLE);
  const paddleRight = createTag('button', {
    class: 'paddle paddle-right', disabled: '', 'aria-hidden': true, 'aria-label': 'Scroll tabs to right',
  }, PADDLE);
